...
public class Configs {
    ...
    @Property(
            ...
            name = "Easy Trigger Pair 1 - On Receive",
            parent = "Easy Trigger Pair 1"
    )
    public static String EasyTriggerPair1OnReceive = "^Party > (\\[MVP\\+*\\]|\\[VIP\\+*\\]|)[0-9a-zA-Z_]+: Mimic Dead!$";

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Display Title for 300 announce",
            parent = "Score"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Shadow Assassin ESP Box",
            parent = "Shadow Assassin ESP",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Auto Sell Infinite Quiver VI-VII",
            parent = "Auto Sell Enchanted Book"
    )
    public static boolean AutoSellInfiniteQuiver = false;

    @Property(
            type = Property.Type.NUMBER,
            name = "Clicks in Advance",
            parent = "Terminals",
            min = 1,
            max = 40,
    ...
    public static boolean ColorNameTab = false;

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Trap Chest ESP Enable",
            parent = "Trap Chest ESP",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Simon Says Block Wrong Clicks",
            parent = "Simon Says Solver",
    ...
    @Property(
            type = Property.Type.NUMBER,
            name = "Terminator rightclick CPS",
            parent = "Hold Right Click",
            min = 10,
            max = 100
    )
    ...
    @Property(
            type = Property.Type.FOLDER,
            name = "bn Chat Settings",
            parent = "Misc",
            description = "&c/xc&r to see how to use this channel."
    )
    public static boolean bnCSetting = false;

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Ghast ESP",
            parent = "Nether Mob ESP"
    )
    ...
    @Property(
            ...
            name = "Golem",
            parent = "Bestiary",
            description = "Endstone Protector features."
    )
    public static boolean GolemAlertEnable = false;

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Dragon Info Display Test",
            parent = "Dragon Info Display",
            description = "Display lines to show where the display is at."
    )
    public static boolean dragonInfoTest = false;

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Safer Auto Move",
            parent = "Fishing",
            description = "Disable Auto Move on world change."
    )
    public static boolean SafeAutoMove = false;

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Auto Shoot Crystal",
            parent = "Dragon",
            illegal = true,
    ...
    @Property(
            type = Property.Type.NUMBER,
            name = "Mastery Helper - Auto Release Right Click When",
            parent = "Dojo",
            min = 500,
            max = 1500,
            step = 10,
            description = "Set when to release right click."
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Auto Sell Magnet VI Book",
            parent = "Auto Sell Fishing Stuff"
    )
    public static boolean AutoSellMagnet = false;

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Simon Says Solver Enable",
            parent = "Simon Says Solver",
            description = "Show where to click and block wrong clicks."
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "No Rotate Disable When In Teleport Maze",
            parent = "No Rotate",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Click Screen Maddox",
            parent = "Other Slayer Features",
    ...
    @Property(
            type = Property.Type.NUMBER,
            name = "Auto Question CD",
            parent = "Auto Question",
            suffix = " ms",
            min = 0,
            max = 2000,
            step = 20
    ...
    @Property(
            type = Property.Type.NUMBER,
            name = "Nearby Etherwarp Point Radius",
            parent = "Show Etherwarp Point",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "No Rotate Disable When Holding Leaps",
            parent = "No Rotate"
    )
    ...
    @Property(
            ...
            name = "Spirit Bow ESP Color",
            parent = "M4 ESP",
            options = {"§aGreen", "§bAqua", "§cRed", "§dPink", "§eYellow", "§fWhite", "§0Black", "§1Dark Blue", "§2Dark Green", "§3Cyan", "§4Dark Red", "§5Purple", "§6Gold", "§7Gray", "§8Dark Gray", "§9Blue"}
    )
    ...
    @Property(
            type = Property.Type.NUMBER,
            name = "PillarDisplay Y",
            parent = "Pillar Display"
    )
    public static int PillarY = 160;

    @Property(
            type = Property.Type.NUMBER,
            name = "Auto Experimentation Table CD",
            parent = "Auto Experimentation Table",
            suffix = " ms",
            min = 50,
            max = 800,
            step = 50
    ...
    @Property(
            type = Property.Type.SELECT,
            name = "Starred Mob ESP Kind",
            parent = "Starred Mob ESP",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Render Rank",
            parent = "Render Name Related",
            description = "Render rank on top of heads."
    )
    public static boolean RenderRank = false;

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Secret Checker",
            parent = "Other Dungeon Features",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "No Slowdown - SkyBlock Only",
            parent = "No Slowdown"
    )
    public static boolean DisableNoSlowOutofSkyBlock = false;

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Raw Click",
            parent = "General bogdanaddon Setting",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "No Slowdown for Rogue Sword",
            parent = "No Slowdown"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Show Etherwarp Point Enable",
            parent = "Show Etherwarp Point"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Find Fairy Grotto Map Enable",
            parent = "Find Fairy Grotto",
    ...
    @Property(
            type = Property.Type.NUMBER,
            name = "Kuudra Display Scale",
            parent = "Kuudra Display",
            min = 5,
            max = 100
    )
    ...
    @Property(
            type = Property.Type.TEXT,
            name = "Easy Trigger Pair 5 - On Receive",
            parent = "Easy Trigger Pair 5"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Map Display Enabled",
            parent = "Map",
            description = "Disable this if you don't want to see this shit."
    )
    public static boolean MapDisplay = false;
    ...
    @Property(
            type = Property.Type.NUMBER,
            name = "Sneaky Creeper Search Radius",
            parent = "Gunpowder Mines",
            description = "OwO",
            min = 50,
            max = 90
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Can Sell Recomed Loots with Non-full Quality",
            parent = "Auto Sell Dungeon Armor"
    )
    public static boolean CanAutoSellRecomed = false;

    @Property(
            type = Property.Type.TEXT,
            name = "Easy Trigger Pair 2 - On Receive",
            parent = "Easy Trigger Pair 2"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Show Revenant miniboss HP",
            parent = "Revenant",
    ...
    @Property(
            ...
            name = "Illegal Map",
            parent = "Dungeons",
            description = "Based on UnclaimedBloom6's dmap",
            illegal = true
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Auto Sell Non-recomed Fairy Set",
            parent = "Auto Sell Fishing Stuff"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Auto Sell Cheap Runes",
            parent = "Auto Sell Miscellaneous",
            description = "&c/bn show runes&r to see list"
    )
    public static boolean AutoSellRunes = false;

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Show Player Name in Leaps",
            parent = "Spirit Leap"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Auto Crystal Hollows Chest - Close",
            parent = "Powder Relevant",
            description = "Automatically closes powder chests opened by Auto Crystal Hollows Chest."
    )
    public static boolean AutoPowderChestClose = false;

    @Property(
            type = Property.Type.NUMBER,
            name = "Rogue Sword rightclick CPS",
            parent = "Hold Right Click",
            min = 1,
            max = 250,
            step = 3
    ...
    @Property(
            type = Property.Type.SELECT,
            name = "Mastery Helper Mode",
            parent = "Dojo",
            options = {"Estimate", "Official"}
    )
    public static int MasteryMode = 0;

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Auto Move Recast",
            parent = "Fishing",
            description = "Recast fishing rod when rod is active for too long and auto-move is on."
    )
    public static boolean AutoMoveRecast = false;

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Auto Sell Fine Gemstone",
            parent = "Auto Sell Mining Stuff"
    )
    public static boolean AutoSellFineGem = false;

    @Property(
            type = Property.Type.NUMBER,
            name = "(Fairy) Map Scale",
            parent = "Find Fairy Grotto",
            min = 1,
            max = 10
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Remove Dragon Hurt Render",
            parent = "M7 Phase 5",
            description = "So you can see its color more easily."
    )
    public static boolean RemoveDragonHurtRender = false;

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Auto Bottle Enable",
            parent = "Auto Bottle"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Show Nearby Etherwarp Point",
            parent = "Show Etherwarp Point",
            description = "Show nearby possible etherwarp points."
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Auto Sell Normal Dungeon Trash",
            parent = "Auto Sell Dungeon Trash"
    )
    public static boolean AutoSellDungeonTrash = false;

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Show Attribute Enable",
            parent = "Show Attribute"
    )
    public static boolean ShowAttribute = false;

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Ghost Sword Swap",
            parent = "Other QOLs",
            illegal = true,
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Auto Sell Ultimate Jerry I-V",
            parent = "Auto Sell Enchanted Book"
    )
    ...
    @Property(
            type = Property.Type.NUMBER,
            name = "Auto Build Farm - Step 1 CD",
            parent = "Farming",
            description = "CD between placing dirt. Must be higher than your ping.",
            min = 100,
            max = 2000,
            step = 20
    )
    ...
    @Property(
            type = Property.Type.TEXT,
            name = "Easy Trigger Pair 1 - Do Command",
            parent = "Easy Trigger Pair 1"
    )
    ...
    public static boolean ScoreCalculation = false;

    @Property(
            type = Property.Type.NUMBER,
            name = "Plasmaflux CD",
            parent = "Auto Use Item",
            suffix = " s",
            min = 0,
            max = 120
    )
    ...
    @Property(
            ...
            parent = "bn Chat Settings"
    )
    public static boolean HideDeathMessages = false;

    @Property(
            type = Property.Type.BOOLEAN,
            name = "0 ping for Auto Terminal",
            parent = "Terminals",
            illegal = true,
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Three Weirdos Solver Enable",
            parent = "Solvers",
    ...
    @Property(
            type = Property.Type.TEXT,
            name = "Easy Trigger Pair 3 - On Receive",
            parent = "Easy Trigger Pair 3"
    )
    public static String EasyTriggerPair3OnReceive = "";

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Combine Ferocious Mana",
            parent = "Auto Combine"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Auto Sell Trash Dungeon Armor",
            parent = "Auto Sell Dungeon Armor",
    ...
    public static boolean AssumeSpirit = false;

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Show Livid with ESP",
            parent = "Show Livid",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Velocity - SkyBlock Only",
            parent = "Velocity"
    )
    public static boolean DisableOutofSkyBlock = false;
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Auto Left Click Enable",
            parent = "Auto Left Click",
            description = "KeyBind."
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Show Chest Profit",
            parent = "Price Related",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Auto Sell Wishing Compass",
            parent = "Auto Sell Mining Stuff"
    )
    ...
    @Property(
            type = Property.Type.TEXT,
            name = "Easy Trigger Pair 4 - Do Command",
            parent = "Easy Trigger Pair 4"
    )
    ...
    @Property(
            type = Property.Type.FOLDER,
            name = "No Rotate",
            parent = "Dangerous Features"
    )
    public static boolean NoRotateEnabled = false;

    @Property(
            type = Property.Type.FOLDER,
            name = "Auto Sell Enchanted Book",
            parent = "Auto Sell"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Block Pickobulus in Private Island",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Easy Trigger Pair 5 Enabled",
            parent = "Easy Trigger Pair 5"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Auto Sell Enchanted Golden Apple",
            parent = "Auto Sell Fishing Stuff"
    )
    ...
    @Property(
            type = Property.Type.NUMBER,
            name = "Auto Build Farm - Step 5 CD",
            parent = "Farming",
            description = "CD between placing blocks.",
            min = 20,
            max = 2000,
            step = 20
    )
    ...
    @Property(
            type = Property.Type.TEXT,
            name = "Easy Trigger Pair 2 - Do Command",
            parent = "Easy Trigger Pair 2"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Hide Golden Fish",
            parent = "Hide Entity Features"
    )
    public static boolean HideGoldenFish = false;

    @Property(
            type = Property.Type.FOLDER,
            name = "Hide Entity Features",
            parent = "QOL"
    )
    ...
    @Property(
            type = Property.Type.TEXT,
            name = "Attribute 1",
            parent = "Item Attribute Filter"
    )
    public static String Attribute1 = "double_hook";

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Ashfang Acolyte ESP",
            parent = "Ashfang"
    )
    ...
    @Property(
            type = Property.Type.NUMBER,
            name = "Turn-Shoot Delay",
            parent = "Blaze Solver",
            suffix = " ms",
            description = "Delay between a turn and a shot.\nHigher delay = Lower chance to fail.",
            min = 50,
            max = 500,
            step = 5
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Show Puzzle Room Name",
            parent = "Rooms"
    )
    public static boolean ShowPuzzleName = false;

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Ender Crystal ESP",
            parent = "Dragon",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Auto Sell No Pain No Gain I-V",
            parent = "Auto Sell Enchanted Book"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Disable Map In Boss",
            parent = "Map"
    )
    public static boolean DisableMapInBoss = false;

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Corrupted Mob ESP",
            parent = "Nether Mob ESP",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Easy Trigger Debug Mode",
            parent = "Easy Trigger"
    )
    public static boolean EasyTriggerDebugMode = false;
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Old Block Break",
            parent = "Old Animations",
    ...
    @Property(
            type = Property.Type.FOLDER,
            name = "General bogdanaddon Setting",
            parent = "Misc"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Color Name NameTag",
            parent = "Color Name",
            description = "Color name in custom name tag of entities, such as pet."
    )
    public static boolean ColorNameNameTag = false;

    @Property(
            type = Property.Type.BOOLEAN,
            name = "No Slowdown for Wither Blades",
            parent = "No Slowdown"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Dragon Info Display Enable",
            parent = "Dragon Info Display",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Auto Fuse Attribute Enabled",
            parent = "Auto Fuse Attribute"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Can Sell Full Quality Loots with Non-recomed",
            parent = "Auto Sell Dungeon Armor"
    )
    public static boolean CanAutoSellFullQuality = false;
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Show Trap Room Name",
            parent = "Rooms"
    )
    public static boolean ShowTrapName = false;

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Nake Prevention",
            parent = "In Combat QOL",
            description = "When Auto-Swapping Armor"
    )
    public static boolean NakePrevention = false;
    ...
    @Property(
            type = Property.Type.NUMBER,
            name = "Sneaky Creeper Optimize Param",
            parent = "Gunpowder Mines",
            description = "OwO",
            min = 1,
            max = 60
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "General ESP toggle",
            parent = "General bogdanaddon Setting"
    )
    public static boolean GeneralESP = false;
    ...
    @Property(
            type = Property.Type.NUMBER,
            name = "Auto Blood Yoffset (0.1x block)",
            parent = "Auto Blood",
            min = 0,
            max = 20,
            description = "Higher ping, higher offset!"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Hide Puzzle Fail Messages",
            parent = "bn Chat Settings"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Color Name Scoreboard",
            parent = "Color Name",
            description = "Color name in dungeon scoreboard."
    )
    public static boolean ColorNameScoreboard = false;
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Velocity Stop When Player Neaby",
            parent = "Velocity"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Auto Move - Press Sneak",
            parent = "Fishing"
    )
    public static boolean AutoMoveSneak = false;

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Kuudra Info Display Test",
            parent = "Kuudra Display",
            description = "Display lines to show where the display is at."
    )
    public static boolean KuudraTest = false;

    @Property(
            type = Property.Type.NUMBER,
            name = "P3 Arrows CD Between ItemFrames",
            parent = "Auto P3-3",
            suffix = " ms",
            min = 100,
            max = 500,
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Show Book Name Enable",
            parent = "Show Book Name"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Auto Close Loot Chests in Crystal Hollows",
            parent = "Powder Relevant"
    )
    ...
    @Property(
            type = Property.Type.FOLDER,
            name = "Auto Sell Dungeon Armor",
            parent = "Auto Sell",
            description = "&c/bn show dungarmor&r to see selling list"
    )
    public static boolean AutoSellDungeonArmorEnable = false;

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Show BroodMother Box",
            parent = "Brood Mother",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Item Attribute Filter Enable",
            parent = "Item Attribute Filter"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Kuudra Info Display Enable",
            parent = "Kuudra Display"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Chat Hover Enabled",
            parent = "Chat Hover"
    )
    public static boolean ChatHoverCommand = false;
    ...
    public static boolean JawbusWarn = false;

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Pillar Info Display Test",
            parent = "Pillar Display",
            description = "Display lines to show where the display is at."
    )
    public static boolean PillarTest = false;
    ...
    @Property(
            type = Property.Type.SELECT,
            name = "Arachne Keeper Warn",
            parent = "Arachne's Keeper",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Display Packet Received Frequency",
            parent = "Information Display"
    )
    ...
    @Property(
            type = Property.Type.NUMBER,
            name = "Auto Pulling Rod Blob Time",
            parent = "Fishing",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Keep Sprinting Enable",
            parent = "Keep Sprinting",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Ashfang Gravity Center ESP",
            parent = "Ashfang"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Show Livid with Filled Box",
            parent = "Show Livid",
    ...
    @Property(
            type = Property.Type.FOLDER,
            name = "Auto Sell Dungeon Trash",
            parent = "Auto Sell",
            description = "&c/bn show dungtrash&r to see list"
    )
    public static boolean AutoSellDungeonTrashEnable = false;

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Gemstone ESP Enable",
            parent = "Gemstone ESP"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Auto Move - Stop When New Discovery",
            parent = "Fishing"
    )
    ...
    @Property(
            ...
            max = 200,
            step = 10,
            description = "Cool down between rotating and clicking."
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Display Packet Sent Frequency",
            parent = "Information Display"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Simon Says Auto Change Direction",
            parent = "Simon Says Solver",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Show bogdanaddon Message",
            parent = "General bogdanaddon Setting",
            description = "Show the messages starting with \"bogdanaddon >\"."
    )
    public static boolean ShowbogdanaddonMessage = true;

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Auto Sell Feather Falling VI-VII",
            parent = "Auto Sell Enchanted Book"
    )
    ...
    @Property(
            type = Property.Type.NUMBER,
            name = "Dragon Info Display Scale",
            parent = "Dragon Info Display",
            min = 5,
            max = 100
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Crystal Hollows Nearby Chest ESP",
            parent = "Other QOLs",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Titanium ESP",
            parent = "Nether Block ESP",
            description = "This is not supposed to be in nether block esp but i have 5 hours left with 2k hotm exp so"
    )
    public static boolean TitaniumESP = false;

    @Property(
            type = Property.Type.TEXT,
            name = "Auto Fuse - Attribute 1",
            parent = "Auto Fuse Attribute"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Rogue Sword rightclick Enable",
            illegal = true,
            parent = "Hold Right Click",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Can Sell Full Quality Recomed Loots",
            parent = "Auto Sell Dungeon Armor"
    )
    ...
    @Property(
            type = Property.Type.TEXT,
            name = "Possible Etherwarp Points Color",
            parent = "Show Etherwarp Point",
            description = "Hex code of color (argb). Example: FFFF1234"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Show Tarantula miniboss HP",
            parent = "Tarantula",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Stonkless Stonk without Pickaxe",
            parent = "Stonkless Stonk",
            illegal = true
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Mastery Helper - Auto Release Right Click",
            parent = "Dojo"
    )
    ...
    @Property(
            type = Property.Type.NUMBER,
            name = "Blaze Slayer Helper Cache Time",
            parent = "Blaze",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Terminator rightclick Enable",
            illegal = true,
            parent = "Hold Right Click",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Auto Sell Enchanted Feather",
            parent = "Auto Sell Fishing Stuff"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Block Ancestral Spade - Invalid Clicks",
            parent = "Mythological",
            description = "Blocks using ancestral spade if you are not looking straight up nor down."
    )
    public static boolean BlockInvalidClicks = false;

    @Property(
            type = Property.Type.NUMBER,
            name = "(Sneaky) Map Scale",
            parent = "Gunpowder Mines",
            min = 1,
            max = 10
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Easy Trigger Pair 1 Enabled",
            parent = "Easy Trigger Pair 1"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Show Best Shadow Fury Points",
            parent = "Arachne's Keeper",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Easy Trigger Pair 3 Enabled",
            parent = "Easy Trigger Pair 3"
    )
    ...
    @Property(
            type = Property.Type.NUMBER,
            name = "Etherwarp Point Bounding Thickness",
            parent = "Show Etherwarp Point",
            max = 10
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Sneaky Creeper Map Enable",
            parent = "Gunpowder Mines",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Close Gui When Clicking",
            parent = "General bogdanaddon Setting"
    )
    public static boolean CloseInvWhenClicking = false;

    @Property(
            type = Property.Type.TEXT,
            name = "Show Attribute Contains",
            parent = "Show Attribute",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "No Slowdown for All Swords",
            parent = "No Slowdown"
    )
    ...
    @Property(
            type = Property.Type.TEXT,
            name = "Etherwarp Point Bounding Color",
            parent = "Show Etherwarp Point",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Close Gui When Changing Direction",
            parent = "General bogdanaddon Setting"
    )
    public static boolean CloseInvWhenChangingDirection = false;
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Hide bogdanaddon mod id",
            parent = "General bogdanaddon Setting",
            description = "Not let the server know that you have bogdanqol installed.\n&cRestart after changing required."
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Pillar Info Display Enable",
            parent = "Pillar Display"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Can Sell Training Weight with >100 minutes held",
            parent = "Auto Sell Dungeon Trash"
    )
    ...
    @Property(
            type = Property.Type.TEXT,
            name = "Easy Trigger Pair 5 - Do Command",
            parent = "Easy Trigger Pair 5"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Always Highlight Wither doors",
            parent = "Rooms"
    )
    public static boolean AlwaysHighlightWitherDoor = false;

    @Property(
            type = Property.Type.FOLDER,
            name = "Powder Relevant",
            parent = "Skills"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Auto Click Mage When opening Leaps",
            parent = "Spirit Leap",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Show Voidgloom miniboss HP",
            parent = "Voidgloom",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Color Name Chat",
            parent = "Color Name",
            description = "Color name in chat messages."
    )
    public static boolean ColorNameChat = false;

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Combine Ultimate Wise",
            parent = "Auto Combine"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Coords Ghost Block Enable",
            parent = "Coords Ghost Block",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Auto Crystal Hollows Chest",
            parent = "Powder Relevant",
            illegal = true,
    ...
    public static boolean ColorNameTitle = false;
    ...
    @Property(
            type = Property.Type.TEXT,
            name = "Easy Trigger Pair 4 - On Receive",
            parent = "Easy Trigger Pair 4"
    )
    ...
    @Property(
            ...
            name = "Color Name",
            parent = "Misc",
            description = "Replace all ranked name, like &b[MVP+] bogdan,\nto ranked colored name &6[RANK] &2bogdan&r;\nReplace all name, like bogdan,\nto colored name &2bogdan&r.\n&cWon't work while nicked!"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Block Gloomlock Grimoire RightClick",
            parent = "Block Abilities"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Remove Hurt Camera Enable",
            parent = "Remove Hurt Camera"
    )
    public static boolean RemoveHurtCam = false;

    @Property(
            type = Property.Type.BOOLEAN,
            name = "Protect Items Enable",
            parent = "Protect Items"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Easy Trigger Pair 2 Enabled",
            parent = "Easy Trigger Pair 2"
    )
    ...
    @Property(
            type = Property.Type.NUMBER,
            name = "Sneaky Creeper Split Count",
            parent = "Gunpowder Mines",
            description = "OwO",
            min = 1,
            max = 200
    ...
    @Property(
            type = Property.Type.TEXT,
            name = "Easy Trigger Pair 3 - Do Command",
            parent = "Easy Trigger Pair 3"
    )
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Can Sell Recomed Dungeon Trash",
            parent = "Auto Sell Dungeon Trash",
            description = "like Defuse Kit"
    )
    ...
    public static boolean RenderSelfName = false;

    @Property(
            type = Property.Type.SELECT,
            name = "Replace Dragon Texture",
            parent = "M7 Phase 5",
    ...
    @Property(
            type = Property.Type.BOOLEAN,
            name = "Easy Trigger Pair 4 Enabled",
            parent = "Easy Trigger Pair 4"
    )
    ...
    @Property(
            type = Property.Type.NUMBER,
            name = "Darken Unexplored Factor",
            parent = "Rooms",
            description = "Determine how dark unexplored rooms are.",
            suffix = " %",
            min = 0,
            max = 100
    )
