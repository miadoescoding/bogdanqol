...
import com.bogdan.qol.Config.Setting.NumberSetting;
...
public class NumberInput extends Button {
    ...
    public NumberInput(ConfigGuiNew var1, NumberSetting var2, int var3, int var4) {
        ...
        this.minusWidth = bogdanqol.mc.fontRendererObj.getStringWidth("-");
        this.plusWidth = bogdanqol.mc.fontRendererObj.getStringWidth("+");
        this.superMinusWidth = bogdanqol.mc.fontRendererObj.getStringWidth("--");
        this.superPlusWidth = bogdanqol.mc.fontRendererObj.getStringWidth("++");
        this.gap = 3;
        this.setting = var2;
        this.height = 10;
        this.width = bogdanqol.mc.fontRendererObj.getStringWidth(var2.max + "");
        if (var2.prefix != null) {
            this.width += bogdanqol.mc.fontRendererObj.getStringWidth(var2.prefix);
        }

        if (var2.suffix != null) {
            this.width += bogdanqol.mc.fontRendererObj.getStringWidth(var2.suffix);
        }
