...
import com.bogdan.qol.Config.Setting.SelectSetting;
...
public class SelectInput extends Button {
    ...
    public SelectInput(ConfigGuiNew var1, SelectSetting var2, int var3, int var4) {
        ...
        this.leftWidth = bogdanqol.mc.fontRendererObj.getStringWidth("<");
        this.rightWidth = bogdanqol.mc.fontRendererObj.getStringWidth(">");
        this.gap = 3;
        this.setting = var2;
        int var5 = 0;
        ...
        for (int var8 = 0; var8 < var7; ++var8) {
            ...
            var5 = Math.max(var5, bogdanqol.mc.fontRendererObj.getStringWidth(var9));
        }
