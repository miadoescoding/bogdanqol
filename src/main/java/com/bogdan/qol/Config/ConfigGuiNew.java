...
import com.bogdan.qol.Config.ButtonsNew.Button;
import com.bogdan.qol.Config.ButtonsNew.ClearTextButton;
import com.bogdan.qol.Config.ButtonsNew.CloseButton;
import com.bogdan.qol.Config.ButtonsNew.TextInput;
import com.bogdan.qol.Config.Setting.BooleanSetting;
import com.bogdan.qol.Config.Setting.FolderSetting;
import com.bogdan.qol.Config.Setting.Setting;
...
public class ConfigGuiNew extends GuiScreen {
    ...
    private static void getSettings() {
        ...
        Iterator var2 = bogdanqol.settings.iterator();
        ...
        if (searchBar != null && !searchBar.getText().equals("")) {
            ...
            Iterator var4 = bogdanqol.settings.iterator();
    ...
    private void drawSearchBar(int var1, int var2, int var3, int var4, int var5) {
        ...
        GuiUtils.drawTexture(new ResourceLocation("bogdanqol:search.png"), var1 + var6, var2 + var6, var5, var5);
    ...
    public void drawScreen(int var1, int var2, float var3) {
        ...
        byte var6 = 9;
        String var7 = "bogdanqol 2.0";
        this.drawCenteredString(this.mc.fontRendererObj, var7, var4 + this.mc.fontRendererObj.getStringWidth(var7) / 2 + var6, var5 + 15 - 3, -1);
        GuiUtils.drawTexture(new ResourceLocation("bogdanqol:deny-16x16.png"), var4 + 500 - var6 - 12, var5 + var6, 12, 12);
    ...
    public void onGuiClosed() {
        bogdanqol.mc.gameSettings.guiScale = this.startScale;
        Config.save();
    }
