...
public class ChatLib {
    ...
    public static void playerJoin(String var0) {
        if (!toggleOff) {
            String var1 = "&bbn > &r&8" + var0 + " &ejoined.";
            var1 = addColor(var1);
    ...
    public static void chat(String var0, boolean var1) {
        ...
        if (!Configs.ShowbogdanaddonMessage) {
    ...
    public static void toggle() {
        toggleOff = !toggleOff;
        chat((toggleOff ? "&cDisabled" : "&aEnabled") + "&r&b bn chat!");
    }

    public static void showItem(int var0, String var1, String var2, String var3) {
        if (!toggleOff) {
            if (var0 == 3) {
                String var4 = "&bbn > &r&8" + var1 + "&r&f: &rShowed item ";
                var4 = addColor(var4);
    ...
    public static void playerLeft(String var0) {
        if (!toggleOff) {
            String var1 = "&bbn > &r&8" + var0 + " &eleft.";
            var1 = addColor(var1);
            ChatComponentText var2 = new ChatComponentText(var1);
            addComponent(var2);
        }
