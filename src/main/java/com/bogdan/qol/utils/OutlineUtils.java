...
import com.bogdan.qol.Events.RenderEntityModelEvent;
...
public class OutlineUtils {
    private static void setupFBO(Framebuffer var0) {
        ...
        EXTFramebufferObject.glRenderbufferStorageEXT(36161, 34041, bogdanqol.mc.displayWidth, bogdanqol.mc.displayHeight);
    ...
    private static void setColor(Color var0) {
        GL11.glColor4d((float) var0.getRed() / 255.0F, (float) var0.getGreen() / 255.0F, (float) var0.getBlue() / 255.0F, (float) var0.getAlpha() / 255.0F);
    }
    ...
    private static void checkSetupFBO() {
        Framebuffer var0 = bogdanqol.mc.getFramebuffer();
    ...
    public static void outlineEntity(ModelBase var0, Entity var1, float var2, float var3, float var4, float var5, float var6, float var7, Color var8, int var9) {
        boolean var10 = bogdanqol.mc.gameSettings.fancyGraphics;
        float var11 = bogdanqol.mc.gameSettings.gammaSetting;
        bogdanqol.mc.gameSettings.fancyGraphics = false;
        bogdanqol.mc.gameSettings.gammaSetting = Float.MAX_VALUE;
        ...
        bogdanqol.mc.gameSettings.fancyGraphics = var10;
        bogdanqol.mc.gameSettings.gammaSetting = var11;
    }
}
