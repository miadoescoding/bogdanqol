...
public class RenderUtils {
    ...
    public static int getScreenHeight() {
        return (new ScaledResolution(bogdanqol.mc)).getScaledHeight();
    }

    public static void drawStringWithShadow(String var0, float var1, float var2) {
        bogdanqol.mc.fontRendererObj.drawString(ChatLib.addColor(var0), var1, var2, colorized == null ? -1 : colorized.intValue(), true);
        finishDraw();
    }
    ...
    public static int getStringWidth(String var0) {
        return bogdanqol.mc.fontRendererObj.getStringWidth(var0);
    }
    ...
    public static int getStringHeight(String var0) {
        return bogdanqol.mc.fontRendererObj.FONT_HEIGHT;
    }
    ...
    public static int getScreenWidth() {
        return (new ScaledResolution(bogdanqol.mc)).getScaledWidth();
    }
