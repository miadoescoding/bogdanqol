...
public class BlockUtils {
    ...
    public static AxisAlignedBB getAABBOfBlock(BlockPos var0) {
        ...
        return var1 == null ? null : var1.getSelectedBoundingBox(MinecraftUtils.getWorld(), var0).offset(-bogdanqol.mc.getRenderManager().viewerPosX, -bogdanqol.mc.getRenderManager().viewerPosY, -bogdanqol.mc.getRenderManager().viewerPosZ).expand(0.0010000000474974513, 0.0010000000474974513, 0.0010000000474974513);
    }
    ...
    public static MovingObjectPosition watchingAt() {
        return MinecraftUtils.getPlayer().rayTrace(bogdanqol.mc.playerController.getBlockReachDistance(), 0.0F);
    }
