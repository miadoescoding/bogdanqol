...
public class ControlUtils {
    ...
    static {
        ...
        attackKeyBind = new KeyBind(bogdanqol.mc.gameSettings.keyBindAttack);
        moveForwardKeyBind = new KeyBind(bogdanqol.mc.gameSettings.keyBindForward);
        moveBackwardKeyBind = new KeyBind(bogdanqol.mc.gameSettings.keyBindBack);
        moveLeftKeyBind = new KeyBind(bogdanqol.mc.gameSettings.keyBindLeft);
        moveRightKeyBind = new KeyBind(bogdanqol.mc.gameSettings.keyBindRight);
        sneakKeyBind = new KeyBind(bogdanqol.mc.gameSettings.keyBindSneak);
        sprintKeyBind = new KeyBind(bogdanqol.mc.gameSettings.keyBindSprint);
        jumpKeyBind = new KeyBind(bogdanqol.mc.gameSettings.keyBindJump);
        ...
        try {
            leftClickMethod = bogdanqol.mc.getClass().getDeclaredMethod("clickMouse");
        } catch (NoSuchMethodException var27) {
            try {
                leftClickMethod = bogdanqol.mc.getClass().getDeclaredMethod("func_147116_af");
        ...
        try {
            rightClickMethod = bogdanqol.mc.getClass().getDeclaredMethod("rightClickMouse");
        } catch (NoSuchMethodException var25) {
            try {
                rightClickMethod = bogdanqol.mc.getClass().getDeclaredMethod("func_147121_ag");
    ...
    public static void rightClick() {
        try {
            ...
            if (Configs.RawClick) {
                ...
                rightClickMethod.invoke(bogdanqol.mc);
            }
            ...
            if (MinecraftUtils.getPlayer() != null) {
                ...
                if (var2 != null) {
                    ...
                    if (synHeldItem != null && var1) {
                        try {
                            synHeldItem.invoke(bogdanqol.mc.playerController);
    ...
    public static void releaseRightClick() {
        ...
        if (MinecraftUtils.getPlayer().isUsingItem()) {
            bogdanqol.mc.playerController.onStoppedUsingItem(MinecraftUtils.getPlayer());
        }
    ...
    public static void changeDirection(float var0, float var1) {
        if (!(var1 > 90.0F) && var1 >= -90.0F && var0 >= -180.0F && !(var0 > 180.0F)) {
            ...
            bogdanqol.mc.entityRenderer.getMouseOver(MathUtils.partialTicks);
        } else {
    ...
    public static void leftClick() {
        try {
            ...
            if (Configs.RawClick) {
                ...
                leftClickMethod.invoke(bogdanqol.mc);
            }
        } catch (Exception var1) {
        }
