...
public class EntityUtils {
    ...
    public static List getEntities() {
        ...
        if (var0 == null) {
            ...
            if (Configs.UnloadUnusedNPCEntity && SkyblockUtils.isInNether()) {
                var1.removeIf((var0x) -> {
                    return MathUtils.equal(MathUtils.getX((Entity) var0x), 0.0) && MathUtils.equal(MathUtils.getY((Entity) var0x), 0.0) && MathUtils.equal(MathUtils.getZ((Entity) var0x), 0.0) && ((Entity) var0x).getName().matches("§(d|5)[A-Z][a-z]+ ");
                });
            }
    ...
    public static void tryRightClickEntity(Entity var0, double var1) {
        ...
        double var4 = bogdanqol.mc.playerController.getBlockReachDistance();
        if (var1 > var4) {
            var4 = var1;
        }
        ...
        AxisAlignedBB var9 = var0.getEntityBoundingBox().expand(var8, var8, var8);
        ...
        if (var10 == null) {
            ...
            bogdanqol.mc.getNetHandler().getNetworkManager().sendPacket(new C02PacketUseEntity(var0, var11));
        }
    }
    ...
    public static boolean isPlayer(Entity var0) {
        return var0 instanceof EntityOtherPlayerMP && isPlayer((EntityOtherPlayerMP) var0);
    }
}
