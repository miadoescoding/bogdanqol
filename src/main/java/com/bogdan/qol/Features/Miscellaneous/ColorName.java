...
public class ColorName {
    ...
    public static void setColorMap(String var0, String var1) {
        ...
        rankMap = (new Gson()).fromJson(var0, var2);
        colorMap = (new Gson()).fromJson(var1, var2);
        ...
        if (var0 == null) {
            ...
            if (cachedColorName.containsKey(var0)) {
                ...
                for (Iterator var2 = colorMap.keySet().iterator(); var2.hasNext(); var0 = var0.replace("ᄅ", var6)) {
                    ...
                    var0 = var0.replaceAll("(?<=§bbn > §r§8)" + var3, "ᄅ");
                    var0 = var0.replace(var3, var4 + var3 + "&r");
                    var6 = colorMap.get(var3) + var3 + "&r";
                    if (!rankMap.get(var3).equals("")) {
                        var6 = rankMap.get(var3) + " " + var6;
                    }
                }
    ...
    public static void showCache() {
        ...
        while (var1.hasNext()) {
            ...
            System.err.println(var2.getKey() + " -> " + var2.getValue());
        }
    ...
    public void onToolTip(ItemTooltipEvent var1) {
        if (true) {
            if (Configs.ColorNameItem) {
                ...
                if (!var2.equals("")) {
                    List var3 = var1.toolTip.stream().map(ColorName::addColorName).collect(Collectors.toList());
                    var1.toolTip.clear();
            ...
            if (Configs.ColorNameNameTag) {
                if (var1.entity instanceof EntityPlayer) {
                    ...
                    try {
                        ...
                        var3.set(var2, var5);
                        ScorePlayerTeam var6 = bogdanqol.mc.getNetHandler().getPlayerInfo(var2.getName()).getPlayerTeam();
                        var6.setNamePrefix("");
                        var6.setNameSuffix("");
