    ...
    private boolean isFairySoul(EntityArmorStand var1) {
        try {
            ...
            if (var2 == null) {
                ...
                return var2.getItem() == Items.skull && var2.getMetadata() == 3 && var2.getTagCompound().getCompoundTag("SkullOwner").getString("Id").equals("57a4c8dc-9b8e-3d41-80da-a608901a6147");
            }
