    ...
    public static void showBloodMobs() {
        ...
        while (var0.hasNext()) {
            ...
            if (var2 instanceof EntityArmorStand) {
                ...
                System.err.printf("pos: (%.2f %.2f %.2f)%n", var2.posX, var2.posY, var2.posZ);
            }
        }
                    ...
                    while (true) {
                        while (var3.hasNext()) {
                            ...
                            if (var9 != null && var9.startTime < TimeUtils.curTime() - 5000L) {
                                ...
                                if (var9.lastX == var4.posX && var9.lastY == var4.posY && var9.lastZ == var4.posZ) {
                ...
                if (SkyblockUtils.isInDungeon()) {
                    if (Dungeon.bossEntry <= Dungeon.runStarted) {
                        ...
                        while (var2.hasNext()) {
                            ...
                            if (var5 != null && var5.endX >= -10000.0F) {
