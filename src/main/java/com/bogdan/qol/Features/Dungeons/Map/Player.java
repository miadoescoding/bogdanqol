...
public class Player {
    ...
    public void renderName() {
        ...
        RenderUtils.drawStringWithShadow(ColorUtils.colors[Configs.PlayerNameColor] + this.name, ((float) (-bogdanqol.mc.fontRendererObj.getStringWidth(this.name)) + this.size.x * 2.0F) / 2.0F, this.size.y * 2.0F);
    }
