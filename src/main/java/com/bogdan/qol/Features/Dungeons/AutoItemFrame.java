                            ...
                            this.thread = new Thread(() -> {
                                try {
                                    ...
                                    if (grid.size() < 25) {
                                        ...
                                        if (neededRotation.isEmpty()) {
                                        ...
                                        } else if (bogdanqol.mc.objectMouseOver != null && bogdanqol.mc.objectMouseOver.entityHit != null) {
                                            Entity var0 = bogdanqol.mc.objectMouseOver.entityHit;
                                            ...
                                            for (int var6 = 0; var6 < var5; ++var6) {
                                                if (bogdanqol.mc.objectMouseOver == null || bogdanqol.mc.objectMouseOver.entityHit != var0) {
                                                    return;
                                                }

                                                if ((Integer) neededRotation.get(var4) == ((EntityItemFrame) bogdanqol.mc.objectMouseOver.entityHit).getRotation()) {
                                                    return;
                                                }
