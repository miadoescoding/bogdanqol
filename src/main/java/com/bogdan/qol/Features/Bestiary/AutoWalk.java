...
import com.bogdan.qol.Objects.Image;
...
public abstract class AutoWalk {
                    ...
                    this.runningThread = new Thread(() -> {
                        try {
                            ...
                            while (this.should) {
                                ...
                                for (long var3 = TimeUtils.curTime(); MathUtils.distanceSquareFromPlayer(this.goingTo.getX(), MathUtils.getY(MinecraftUtils.getPlayer()) + 1.5F, this.goingTo.getZ()) > this.getJudgeDistance() * this.getJudgeDistance() && this.should; Thread.sleep(20L)) {
    ...
    private HashSet getCreepersAlong(int var1, int var2, HashSet var3, HashSet var4, List var5) {
        ...
        for (int var10 = 0; var10 <= var9; ++var10) {
            ...
            Vector3d var12 = new Vector3d(var7.getX() - var6.getX(), var7.getY() - var6.getY(), var7.getZ() - var6.getZ());
            var12.scale((double) var10 / (double) var9);
            var11.add(var12);
