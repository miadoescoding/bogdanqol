...
public class AutoBuildFarmVertical {
        ...
        if (!isLightBlock(var0)) {
            ...
            for (int var3 = 0; var3 < 45; ++var3) {
                if (isLightBlock(var2.getItemInSlot(var3))) {
                    bogdanqol.mc.playerController.windowClick(var2.getWindowId(), var3, var1, 2, MinecraftUtils.getPlayer());
                    Thread.sleep(100L);
    ...
    public static void setFarmingPoint(int var0, int var1) {
        ...
        from = var0;
        to = var1;
        startPos = new BlockPos(var2, var3, var4);
                                ...
                                (new Thread(() -> {
                                    try {
                                        ...
                                        while (enabled()) {
                                            ...
                                            ControlUtils.faceSlowly(-MathUtils.getYaw(), -25.0);

                                            while (MathUtils.getY(MinecraftUtils.getPlayer()) != var0 - 3.0F && MathUtils.getY(MinecraftUtils.getPlayer()) <= var0 + 3.0F && enabled()) {
                                                Thread.sleep(20L);
                                            }
                                ...
                                (new Thread(() -> {
                                    try {
                                        ...
                                        while (enabled()) {
                                            ...
                                            ControlUtils.releaseForward();
                                            ControlUtils.faceSlowly(-MathUtils.getYaw(), -10.0);
                                    ...
                                    try {
                                        ...
                                        while (var1.hasNext()) {
                                            ...
                                            while (BlockUtils.isBlockAir(var2) && enabled()) {
                                                ...
                                                if (MathUtils.distanceSquareFromPlayer(var19) > 484.0) {
                                                    ChatLib.chat("Get Closer!");
                                                    Thread.sleep(1000L);
                                                } else if (MathUtils.distanceSquaredFromPoints(var19, var5) > 0.25) {
                                ...
                                (new Thread(() -> {
                                    try {
                                        ...
                                        if (var2 != null) {
                                            ...
                                            BlockPos var7 = new BlockPos(var18, (double) var19 - 1.0E-4, var6);
                                            BlockPos var8 = new BlockPos(var18, (double) var19 - 1.0E-4, var6 - 1.0F);
                                            BlockPos var9 = new BlockPos(var18, (double) var19 - 1.0E-4, var6 - 2.0F);
                                            BlockPos var10 = new BlockPos(var18, (double) var19 - 1.0E-4, var6 - 3.0F);
                                            ControlUtils.jump();
                                            ControlUtils.jump();
                                            ...
                                            while ((double) MathUtils.getY(MinecraftUtils.getPlayer()) + 1.5 > (double) var19 - 0.5) {
                                                Thread.sleep(20L);
                                            }
                                            ...
                                            while (var7.getY() > from && enabled()) {
                                                ...
                                                while ((double) MathUtils.getY(MinecraftUtils.getPlayer()) + 1.5 > (double) var19 && enabled()) {
                                                    Thread.sleep(20L);
                                                }
