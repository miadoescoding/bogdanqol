...
public class Experimentation {
    ...
    private void clickChronomatron() {
        Objects.requireNonNull(ControlUtils.getOpenedInventory()).click((Integer) chronomatronPatterns.get(this.chronomatronCnt), false, "MIDDLE");
    ...
    private void addChronomatron() {
        ...
        if (var1 == null) {
            ...
            ChatLib.chat("bogdan laji! Cannot find chronomatron.");
        }
    }
}
