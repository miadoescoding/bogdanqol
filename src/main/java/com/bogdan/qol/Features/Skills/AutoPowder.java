                                ...
                                if (Math.random() < 0.05) {
                                    ...
                                    (new Thread(() -> {
                                        try {
                                            ...
                                            MovingObjectPosition var1 = bogdanqol.mc.objectMouseOver;
                                            if (var1 != null && var1.typeOfHit.toString().equals("BLOCK")) {
                                                BlockPos var2 = var1.getBlockPos();
                                                if (var2.getY() >= MathUtils.getBlockY(MinecraftUtils.getPlayer()) && MathUtils.distanceSquareFromPlayer((double) var2.getX() + 0.5, (double) var2.getY() + 0.5, (double) var2.getZ() + 0.5) <= Math.pow(bogdanqol.mc.playerController.getBlockReachDistance(), 2.0)) {
        ...
        for (var12 = var10.getX() + var1; var12 <= var10.getX() + var2; ++var12) {
            for (int var13 = var10.getY() + var3; var13 <= var10.getY() + var4; ++var13) {
                for (int var14 = var10.getZ() + var5; var14 <= var10.getZ() + var6; ++var14) {
                    ...
                    if (MinecraftUtils.getWorld().getBlockState(var15).getBlock() == var7 && !var8.contains(var15) && MathUtils.distanceSquareFromPlayer((float) var15.getX() + 0.5F, (float) var15.getY() + 0.5F, (float) var15.getZ() + 0.5F) <= Math.pow(bogdanqol.mc.playerController.getBlockReachDistance(), 2.0) && (!var9 || MathUtils.checkBlocksBetween(var12, var13, var14))) {
                        var11.add(var15);
                    }
                }
            }
