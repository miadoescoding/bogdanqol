...
import com.bogdan.qol.Features.Accentry.AutoQuestion;
import com.bogdan.qol.Features.Bestiary.GolemAlert;
import com.bogdan.qol.Features.Dungeons.AutoItemFrame;
import com.bogdan.qol.Features.Dungeons.BloodAssist;
import com.bogdan.qol.Features.Dungeons.Map.Data;
...
import com.bogdan.qol.Features.Dungeons.Puzzles.Water.Patterns;
...
import com.bogdan.qol.Features.QOL.BatchCommands;
import com.bogdan.qol.Features.QOL.InCombatQOL;
import com.bogdan.qol.Features.Skills.AutoBuildFarmVertical;
import com.bogdan.qol.Features.Slayers.Blaze;
import com.bogdan.qol.Tests.CopyWorldInfo;
import com.bogdan.qol.Tests.TestM7;
...
public class Command extends CommandBase {
            ...
            if (var2.length == 0) {
                ...
                switch (var6) {
                    case "curmap":
                        ...
                        break;
                    case "s":
                        bogdanqol.guiToOpen = new ConfigGuiNew(bogdanqol.mc.gameSettings.guiScale);
                        bogdanqol.mc.gameSettings.guiScale = 3;
                        break;
                    case "show":
                        String var10 = var2[1];
                        String[] var11 = null;
                    ...
                    case "report":
                        bogdanqol.autoSneakyCreeper.printLog();
                        TabUtils.printTab();
                    ...
                    case "cpblock":
                        ...
                        bogdanqol.mc.theWorld.setBlockState(new BlockPos(var3, var4, var5), BlockUtils.getBlockStateAt(new BlockPos(var15, var16, var17)));
                        break;
                    case "block":
                        if (var2.length == 1) {
                            var3 = MathUtils.floor(MathUtils.getX(MinecraftUtils.getPlayer()));
                    ...
                    case "armorstand":
                        ...
                        break;
                    case "sound":
                        bogdanqol.mc.thePlayer.playSound(var2[1], Float.parseFloat(var2[2]), Float.parseFloat(var2[3]));
                        break;
                    case "setDungeon":
                    ...
                    case "flag":
                        ...
                        break;
                    case "sp":
                        bogdanqol.mc.getNetHandler().handleParticles(new S2APacketParticles(EnumParticleTypes.SMOKE_LARGE, false, MathUtils.getX(MinecraftUtils.getPlayer()), MathUtils.getY(MinecraftUtils.getPlayer()), MathUtils.getZ(MinecraftUtils.getPlayer()), Float.parseFloat(var2[1]), Float.parseFloat(var2[2]), Float.parseFloat(var2[3]), 1.0F, 0));
                        break;
                    case "cp":
                    ...
                    case "tp":
                        ...
                        var4 = Integer.parseInt(var2[2]);
                        var5 = Integer.parseInt(var2[3]);
                        bogdanqol.mc.thePlayer.posX = var3;
                        bogdanqol.mc.thePlayer.posY = var4;
                        bogdanqol.mc.thePlayer.posZ = var5;
                        break;
                    default:
    ...
    private String getUsage() {
        return "&c/bn s&b to open gui settings.\n&c/bn show dungarmor&b, &c/bn show dungtrash&b, and &c/bn show runes&b to show auto-sell dungeon armors/dungeon trash/runes seperately.\n&c/bn rename&b to rename items.\n&c/bn showitem&b to show held item.\n&c/bn keybind&b to set keybinds.\n&c/bn report&b to report a bug.";
    }
}
